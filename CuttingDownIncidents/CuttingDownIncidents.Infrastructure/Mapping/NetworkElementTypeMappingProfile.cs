...
{
    public class NetworkElementTypeMappingProfile : Profile
    {
        public NetworkElementTypeMappingProfile()
        {
            CreateMap<NetworkElementType, NetworkElementTypeDTO>().ReverseMap();
        }
    }
}
